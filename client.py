...
def rightBoard():
    ...
    for box in range(0,11):
        if(box == 10):
            ...
            boxLabel.place(x=xPos+45, y=screen_height/2-88)
...
def finishingBox():
    ...
    finishingBox.place(x=screen_width/2 - 155, y=screen_height/2 -160)
...
def gameWindow():
    ...
    dice = canvas2.create_text(screen_width/2 - 40, screen_height/2 + 150, text = "\u2680", font=("Chalkboard SE",250), fill="white")
...
def handleResetGame():
    ...
    if(playerType == 'player1'):
        ...
        rollButton = Button(gameWindow,text="Roll Dice", fg='black', font=("Chalkboard SE", 15), bg="grey",command=rollDice, width=20, height=5)
        rollButton.place(x=screen_width / 2 , y=screen_height/2 -10)
        playerTurn = True
